  ...
  return (
    <Box sx={{ width: "100%" }} className={classes.box}>
      ...
      <AppBar position="static" color="transparent">
        ...
        >
          <Tab
            label={`${i18n.t("campaignModal.form.tab")} 1`}
            {...a11yProps(0)}
          />
          <Tab
            label={`${i18n.t("campaignModal.form.tab")} 2`}
            {...a11yProps(1)}
          />
          <Tab
            label={`${i18n.t("campaignModal.form.tab")} 3`}
            {...a11yProps(2)}
          />
          <Tab
            label={`${i18n.t("campaignModal.form.tab")} 4`}
            {...a11yProps(3)}
          />
          <Tab
            label={`${i18n.t("campaignModal.form.tab")} 5`}
            {...a11yProps(4)}
          />
        </Tabs>
      </AppBar>
