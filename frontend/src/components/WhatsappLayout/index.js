...
const WhatsAppLayout = ({ message, mediaLink, mediaType }) => {
    return (
        <div>
            <div class="page">
                            ...
                            <div class="conversation-container">
                                <div class="message sent">
                                    { mediaLink && mediaType === "image" ? 
                                        <img src={mediaLink} width={200} height={200} alt="mediaLink" /> : ""
                                    }
                                    { mediaLink && mediaType === "video" ? 
                                        <video autoPlay src={mediaLink} width={200} height={200} /> : ""
                                    }
                                    { mediaLink && mediaType === "audio" ? 
                                        <audio src={mediaLink} width={200} height={200} /> : ""
                                    }
                                    {
                                        message ?
